...
/**
 * 
 * @author lekshmynair Methods to retrieve price info and update price for a
 *         product from/into the data store
 */
public interface PriceDAO {
    /**
     * Method to retrieve price info for a product from the data store
     * 
     * @param prod - product for which price is to be read (with product ID
     *            populated)
